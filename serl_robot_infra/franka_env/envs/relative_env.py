...
class DualRelativeFrame(gym.Wrapper):
    ...
    def step(self, action: np.ndarray):
        ...
        # Update transform matrix
        self.left_transform_matrix = construct_transform_matrix(
            obs["state"]["left/tcp_pose"]
        )
        self.right_transform_matrix = construct_transform_matrix(
    ...
    def transform_observation(self, obs):
        ...
        obs["state"]["right/tcp_vel"] = (
            right_transform_inv @ obs["state"]["right/tcp_vel"]
        )
